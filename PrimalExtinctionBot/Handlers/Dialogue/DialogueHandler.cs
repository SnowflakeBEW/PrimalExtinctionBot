...
namespace PrimalExtinction.Handlers.Dialogue
{
    public class DialogueHandler
    {
        ...
        private DiscordChannel supportChannel;
        private DiscordUser user;
        private DialogueHandler inputDialogueHandler;
        ...
        public DialogueHandler(DiscordClient client, DiscordChannel supportChannel, DiscordUser user, DialogueHandler inputDialogueHandler)
        {
            this.client = client;
            this.supportChannel = supportChannel;
            this.user = user;
            this.inputDialogueHandler = inputDialogueHandler;
        }
